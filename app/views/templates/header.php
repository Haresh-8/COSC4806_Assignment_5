  ...
  <head>
      ...
      <style>
          ...
          .navbar .nav-link { transition: color 0.3s ease, transform 0.2s ease; }
          .navbar .nav-link:hover { color: #ffc107 !important; transform: translateY(-2px); }
          .navbar .nav-link.active { color: #ffc107 !important; font-weight: bold; }
